    ...
    return (
      <div className="max-w-md mx-auto bg-white min-h-screen">
        <div className="p-4 flex items-center justify-between bg-white border-b">
          ...
          <h1 className="text-lg font-semibold">Create Dog Listing</h1>
          <div></div>
        </div>
        ...
        <div className="p-4">
          <Card>
            <CardContent className="py-8 text-center">
              <p className="text-gray-600">Please sign in to create dog listings.</p>
              <Button 
  ...
  return (
    <div className="max-w-6xl mx-auto bg-white min-h-screen">
      <div className="p-4 flex items-center justify-between bg-white border-b sticky top-0 z-10">
        ...
        <h1 className="text-lg font-semibold">Dog Listing Management</h1>
        <div></div>
      </div>
