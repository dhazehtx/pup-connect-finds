          ...
          <div className="p-4">
            <div className="mb-4">
              ...
              <div className="flex space-x-4 overflow-x-auto pb-2">
                ...
                <div className="flex flex-col items-center space-y-2 min-w-0">
                  <div className="w-16 h-16 rounded-full overflow-hidden relative group cursor-pointer">
                    <img 
                    ...
                    <div className="absolute inset-0 bg-black bg-opacity-10 opacity-0 group-hover:opacity-100 transition-opacity duration-200 flex items-center justify-center">
                      <span className="text-white text-xs font-medium text-center px-1">Poodle</span>
                    </div>
                  </div>
                ...
                <div className="flex flex-col items-center space-y-2 min-w-0">
                  <div className="w-16 h-16 rounded-full overflow-hidden relative group cursor-pointer">
                    ...
                    />
                    <div className="absolute inset-0 bg-black bg-opacity-10 opacity-0 group-hover:opacity-100 transition-opacity duration-200 flex items-center justify-center">
                      <span className="text-white text-xs font-medium text-center px-1">Golden Retriever</span>
                    </div>
                  </div>
