...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-white greeting-page">
      {/* Hero Section */}
      <section className="relative bg-white py-16 md:py-24 greeting-page" style={{backgroundColor: '#ffffff', border: 'none', boxShadow: 'none', backgroundImage: 'none'}}>
        <div className="max-w-7xl mx-auto px-4 text-center greeting-page" style={{backgroundColor: '#ffffff', border: 'none', boxShadow: 'none'}}>
