      ...
      <div className="container mx-auto px-4 pb-8">
        <Tabs value={activeTab} onValueChange={setActiveTab} className="marketplace space-y-6">
          <TabsList className="inline-flex rounded-full border-2 border-primary/20 bg-primary/5 p-1 max-w-lg mx-auto">
            <TabsTrigger 
              value="services" 
              className="px-4 py-2 flex items-center gap-2 text-sm font-semibold rounded-full transition-all duration-200 bg-white text-mp-accent border border-mp-border data-[state=active]:!bg-[rgba(79,139,253,0.12)] data-[state=active]:!text-mp-accent data-[state=active]:!border-[rgba(79,139,253,0.35)] focus-visible:!ring-0 focus-visible:!ring-offset-0"
            >
            ...
            <TabsTrigger 
              value="pupbox" 
              className="not-first:ml-1 px-4 py-2 flex items-center gap-2 text-sm font-semibold rounded-full transition-all duration-200 bg-white text-mp-accent border border-mp-border data-[state=active]:!bg-[rgba(79,139,253,0.12)] data-[state=active]:!text-mp-accent data-[state=active]:!border-[rgba(79,139,253,0.35)] focus-visible:!ring-0 focus-visible:!ring-offset-0"
            >
