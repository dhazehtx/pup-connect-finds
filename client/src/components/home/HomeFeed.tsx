    ...
    return (
      <div className="flex flex-col items-center justify-center py-12 px-4">
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6 max-w-md mx-auto text-center">
          ...
          <h3 className="text-lg font-semibold text-yellow-800 mb-2">Feed Loading Issue</h3>
    ...
    return (
      <div className="space-y-4">
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
          ...
          <div className="mt-2 text-yellow-700 text-xs">Showing fallback content below.</div>
        </div>
